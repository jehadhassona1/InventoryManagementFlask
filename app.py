...
def ProductBalance():
    ...
    return render_template('ProductBalance.html' , all_Location=all_Location , all_Product=all_Product , arr=arr , locationNo=len(all_Location))
...
def deleteAllMovement():
    try:
        sqliteConnection = sqlite3.connect('app.db')
        cursor = sqliteConnection.cursor()
        sql_delete_query = """DELETE from product_movement"""
